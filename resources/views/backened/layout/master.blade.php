...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{asset('backened/assets/images/icon/favicon.ico')}}">
    <link rel="stylesheet" href="{{asset('backened/assets/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('backened/assets/css/font-awesome.min.css')}}">
    <link rel="stylesheet" href="{{asset('backened/assets/css/themify-icons.css')}}">
    <link rel="stylesheet" href="{{asset('backened/assets/css/metisMenu.css')}}">
    <link rel="stylesheet" href="{{asset('backened/assets/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('backened/assets/css/slicknav.min.css')}}">
    <!-- amchart css -->
    <link rel="stylesheet" href="https://www.amcharts.com/lib/3/plugins/export/export.css" type="text/css" media="all" />
    <!-- others css -->
    <link rel="stylesheet" href="{{asset('backened/assets/css/typography.css')}}">
...
<body>
    ...
    <script src="{{ asset('backened/assets/js/vendor/jquery-2.2.4.min.js') }}"></script>
    <!-- bootstrap 4 js -->
    <script src="{{ asset('backened/assets/js/popper.min.js') }}"></script>
    <script src="{{ asset('backened/assets/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('backened/assets/js/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('backened/assets/js/metisMenu.min.js') }}"></script>
    <script src="{{ asset('backened/assets/js/jquery.slimscroll.min.js') }}"></script>
    <script src="{{ asset('backened/assets/js/jquery.slicknav.min.js') }}"></script>
    ...
    <script src="{{ asset('backened/assets/js/line-chart.js') }}"></script>
    <!-- all pie chart -->
